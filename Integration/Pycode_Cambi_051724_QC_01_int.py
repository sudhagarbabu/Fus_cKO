...
scVI_embed.to_csv('F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int_scVI_embed.csv')
umap_embed.to_csv('F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int_umap_embed.csv')

adata.write_h5ad("F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int.h5ad", compression="gzip")
adata.obs.to_csv('F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int_obs.csv')
...
## Vis
#adata = sc.read_h5ad('F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int.h5ad')
os.chdir('F:/Colab/Cambi_lab/Integration/QC_01')
...
plot_umap(adata, 'level_1', 'Cambi_051724_QC_01_int_level_1')
plot_umap(adata, 'level_2', 'Cambi_051724_QC_01_int_level_2')
plot_umap(adata, 'class_name', 'Cambi_051724_QC_01_int_class_name')
plot_umap(adata, 'subclass_name', 'Cambi_051724_QC_01_int_subclass_name')
...
plt.tight_layout()
plt.savefig('figures/umap_Cambi_051724_QC_01_int_level_1_by_genotype.pdf', dpi=300)
plt.show()

sc.set_figure_params(dpi=300, dpi_save=300, frameon=False, fontsize=5, figsize=(5, 5))
sc.pl.umap(adata, color="total_counts", save='_Cambi_051724_QC_01_int_n_genes_by_counts.pdf')
sc.pl.umap(adata, color="pct_counts_mt", save='_Cambi_051724_QC_01_int_pct_counts_mt.pdf')
sc.pl.umap(adata, color="scDblFinder.score", save='_Cambi_051724_QC_01_int_scDblFinder.score.pdf')
...
cl_stats.to_csv('F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int_level_2_cluster_stats.csv')
...
de_genes.to_csv('F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int_level_2_marker_genes.csv')
...
cl_stats.to_csv('F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int_level_2_cluster_stats_combined.csv')
...
sc.pl.umap(adata, color='cl_flag', save= '_Cambi_051724_QC_01_int_cl_flag.pdf')

## remove flag
adata.obs['cl_flag'] = adata.obs.apply(lambda row: 'singlet' if row['level_1'] in ['21', '30', '33'] and row['cl_flag'] == 'doublet' else row['cl_flag'], axis=1)
adata.obs["cl_flag"].value_counts()
...
adata.obs['cl_flag'] = adata.obs.apply(lambda row: 'low_quality' if row['level_1'] in ['17', '28', '31'] else row['cl_flag'], axis=1)
adata.obs["cl_flag"].value_counts()
...
## save data
#adata.write_h5ad("F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int.h5ad", compression= "gzip")
adata.obs.to_csv('F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int_obs.csv', index=True)
...
adata = sc.read_h5ad('F:/Colab/Cambi_lab/Data/h5ad/Cambi_051724_dbl_filt.h5ad')
cl_QC_info = pd.read_csv('F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int_obs.csv', index_col=0)
cl_QC_info = cl_QC_info[['cl_flag']].copy()
adata.obs = adata.obs.join(cl_QC_info)
adata.obs["cl_flag"].value_counts()

adata = adata[adata.obs["cl_flag"] == "singlet"].copy()
adata.write_h5ad("F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int_filt.h5ad", compression= "gzip")
adata.obs.to_csv('F:/Colab/Cambi_lab/Integration/QC_01/Cambi_051724_QC_01_int_filt_obs.csv', index=True)
